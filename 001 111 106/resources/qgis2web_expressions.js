...
function exp_R0GStLegerRouteAltRoute_29rule0_eval_expression(context) {
    // "Percentage of Max Steering Angle" >= - 95 AND "Percentage of Max Steering Angle" <= 96

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('Percentage of Max Steering Angle')  >= - 95 ) && (feature.get('Percentage of Max Steering Angle')  <= 96));
    } else {
        return ((feature.get('Percentage of Max Steering Angle')  >= - 95 ) && (feature.get('Percentage of Max Steering Angle')  <= 96));
    }
}
...
function exp_R0GStLegerRouteAltRoute_29rule1_eval_expression(context) {
    // "Percentage of Max Steering Angle" < - 95 OR "Percentage of Max Steering Angle" > 96
...
function exp_Pasted_31rule0_eval_expression(context) {
    // "Percentage of Max Steering Angle" >= - 95 AND "Percentage of Max Steering Angle" <= 96
...
function exp_Pasted_31rule1_eval_expression(context) {
    // "Percentage of Max Steering Angle" < - 95 OR "Percentage of Max Steering Angle" > 96
