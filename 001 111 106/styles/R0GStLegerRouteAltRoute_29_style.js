...
var style_R0GStLegerRouteAltRoute_29 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_R0GStLegerRouteAltRoute_29(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_R0GStLegerRouteAltRoute_29rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_R0GStLegerRouteAltRoute_29rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_R0GStLegerRouteAltRoute_29(feature, value);
        ;
