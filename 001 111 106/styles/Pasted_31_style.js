...
var style_Pasted_31 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_Pasted_31(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_Pasted_31rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_Pasted_31rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_Pasted_31(feature, value);
        ;
